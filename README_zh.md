...
**codespect-matrix** 是一个基于大模型的**多智能体代码进化平台**。24 位专业 AI Agent 通过 **10 阶段管道** 进行**辩论式审查**，经 **CPG 深度污点分析** 追踪跨函数漏洞链，并经由 **Harness 验证引擎** 确保审查质量。
...
- **24 个专业 Agent**：9个规则+LLM混合Agent（安全/医疗/PHI/FHIR/DICOM/HL7/CDS/合规/医学数据）+ 11个LLM推理Agent + 4个动态分析Agent
